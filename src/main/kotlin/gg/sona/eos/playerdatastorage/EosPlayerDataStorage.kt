...
internal class PlayerDataStorageQueryFileOptions(
...
internal class PlayerDataStorageQueryFileListOptions(
    var localUserId: ProductUserId,
) : StructWriter {
    override fun writeTo(arena: Arena): MemorySegment {
        val seg = arena.allocate(LAYOUT)
...
internal class PlayerDataStorageGetFileMetadataCountOptions(
    var localUserId: ProductUserId,
) : StructWriter {
    override fun writeTo(arena: Arena): MemorySegment {
        val seg = arena.allocate(LAYOUT)
...
internal class PlayerDataStorageCopyFileMetadataAtIndexOptions(
    var localUserId: ProductUserId,
    var index: Int,
) : StructWriter {
    override fun writeTo(arena: Arena): MemorySegment {
...
internal class PlayerDataStorageCopyFileMetadataByFilenameOptions(
    var localUserId: ProductUserId,
    var filename: String,
) : StructWriter {
    override fun writeTo(arena: Arena): MemorySegment {
...
internal class PlayerDataStorageDeleteFileOptions(
    var localUserId: ProductUserId,
    var filename: String,
) : StructWriter {
    override fun writeTo(arena: Arena): MemorySegment {
...
internal class PlayerDataStorageDuplicateFileOptions(
    var localUserId: ProductUserId,
    ...
    override fun writeTo(arena: Arena): MemorySegment {
        ...
        seg.setInt32(0, API_LATEST)
        seg.setInt64(8, localUserId.raw)
        seg.setInt64(16, arena.allocCString(sourceFilename).address())
        seg.setInt64(24, arena.allocCString(destinationFilename).address())
        return seg
    }
...
internal class PlayerDataStorageDeleteCacheOptions(var localUserId: ProductUserId?) : StructWriter {
    override fun writeTo(arena: Arena): MemorySegment {
        val seg = arena.allocate(LAYOUT)
        seg.setInt32(0, API_LATEST)
