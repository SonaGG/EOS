...
enum class EosResult(val value: Int) {
    ...
    companion object {
        ...
        fun fromValue(value: Int): EosResult = byValue[value] ?: UnexpectedError

        /** Returns true if the result is [Success]. */
        fun EosResult.isSuccess(): Boolean = this == Success

        /** Returns true if the result is anything other than [Success]. */
        fun EosResult.isFailure(): Boolean = this != Success

        /** Returns true if the result indicates an in-progress operation that will be retried. */
        fun EosResult.willRetry(): Boolean = this == OperationWillRetry
    }
}
